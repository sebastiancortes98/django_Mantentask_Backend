...
ROOT_URLCONF = 'mantentask_project.urls'
...
WSGI_APPLICATION = 'mantentask_project.wsgi.application'
ASGI_APPLICATION = 'mantentask_project.asgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@mantentask.com')
